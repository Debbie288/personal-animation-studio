...
function applyMotion() {
  ...
  /*
    Stop the character engine before rebuilding
    the visual classes.
  */

  if (
    typeof FaceAnimation !== "undefined"
  ) {
  ...
  */
  ...
  /*
    Intensity controls the local
    cinematic motion scale.
  */
  ...
  /*
    Start character life motion.

    This is the foundation for the future
    face/lip-sync animation system.
  */
